 ...
 * like GIT_ASKPASS point to scripts inside the Remnants installation directory, which
...
/**
 * Checks if the current Remnants installation is a Windows user or system setup.
 ...
 * This prevents accumulation of old versions when Remnants updates.
 */
