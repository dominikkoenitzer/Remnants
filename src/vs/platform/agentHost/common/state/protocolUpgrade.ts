 ...
 * by the Remnants CLI, asks the CLI to check for a server upgrade and
 ...
 * data payload. Servers that are spawned by the Remnants CLI populate this
 ...
 * extension used by Remnants-hosted agent hosts.
 *
