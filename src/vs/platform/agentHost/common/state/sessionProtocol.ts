...
// This file adds Remnants-specific additions (ISetAuthTokenParams, ProtocolError)
...
/**
 * Remnants-specific extension: set the auth token on the server.
