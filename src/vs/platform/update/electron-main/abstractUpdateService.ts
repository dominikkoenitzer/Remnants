...
export type UpdateErrorClassification = {
	...
	comment: 'This is used to know how often Remnants updates have failed.';
};
...
export abstract class AbstractUpdateService implements IUpdateService {
	...
	private async trackVersionChange(): Promise<void> {
		...
		type VersionChangeClassification = {
			owner: 'dmitriv';
			comment: 'Fired when Remnants detects a version change on startup.';
			fromVersion: { classification: 'SystemMetaData'; purpose: 'FeatureInsight'; comment: 'The previous version of Remnants.' };
			...
			toVersion: { classification: 'SystemMetaData'; purpose: 'FeatureInsight'; comment: 'The current version of Remnants.' };
