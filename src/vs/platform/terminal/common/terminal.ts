...
export interface IShellLaunchConfig {
	...
	/**
	 * Whether the terminal process environment will inherit Remnants's "shell environment" that may
	 ...
	 * a terminal used to drive some Remnants feature.
	 */
	isFeatureTerminal?: boolean;
	...
	tabActions?: ITerminalTabAction[];
	/**
	 * Report terminal's shell environment variables to Remnants and extensions
	 */
...
export const enum ShellIntegrationStatus {
	...
	FinalTerm,
	/** Remnants shell integration sequences have been encountered. Supercedes FinalTerm. */
	VSCode
}
