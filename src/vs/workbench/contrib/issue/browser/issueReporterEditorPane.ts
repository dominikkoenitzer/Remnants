...
export class IssueReporterEditorPane extends EditorPane {
	...
	override async setInput(
		...
		// AI title generation has been removed. Reset the generate button if the
		// wizard requests title generation so it does not appear stuck.
		this.inputDisposables.add(this.wizard.onDidRequestGenerateTitle(() => {
