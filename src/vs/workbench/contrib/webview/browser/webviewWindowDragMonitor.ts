...
/**
 * Allows webviews to monitor when an element in the Remnants editor is being dragged/dropped.
 *
 * This is required since webview end up eating the drag event. Remnants needs to see this
