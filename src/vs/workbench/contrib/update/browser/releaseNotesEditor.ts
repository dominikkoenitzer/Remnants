 ...
 * - `IN_PRODUCT` - Content shown in Remnants (both Stable and Insiders)
 * - `WEB` - Content shown on the website only
 * - `STABLE` - Content shown in Remnants Stable only
 * - `INSIDERS` - Content shown in Remnants Insiders only
 *
