...
export class ChatMcpAppModel extends Disposable {
	 ...
	 * Remnants restarts — using {@link WebviewOriginStore} for them would
		...
		try {
			...
			switch (request.method) {
				...
				case 'ui/request-display-mode':
					// Remnants only supports inline display mode
	 ...
	 * server-definition id is stable across Remnants restarts. Agent-host
