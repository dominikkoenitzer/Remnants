...
/**
 * Builds a redirect URL that GitHub will use to return the user to Remnants
 ...
 * @param urlProtocol The Remnants URL protocol scheme (e.g. `vscode`, `vscode-insiders`, `code-oss`).
