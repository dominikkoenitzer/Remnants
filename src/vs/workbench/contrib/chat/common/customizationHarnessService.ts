 ...
 *
 * The default (core) registration exposes a single "Remnants" harness
...
export interface ICustomizationHarnessService {
	 ...
	 * Remnants harness falls back to the core prompts service.
	 *
	 ...
	 * Provider-backed harnesses resolve their own items directly; the default Remnants harness falls back to the core prompts service.
	 *
	 * @param sessionResource URI of the chat session whose customizations
...
/**
 * Creates a "Remnants" harness descriptor that shows all storage sources
