...
const DEFAULT_CONTENT: string = [
	`// ${nls.localize('displayLanguage', 'Defines the keyboard layout used in Remnants in the browser environment.')}`,
	`// ${nls.localize('doc', 'Open Remnants and run "Developer: Inspect Key Mappings (JSON)" from Command Palette.')}`,
	``,
