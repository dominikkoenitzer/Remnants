 ...
 * {@link IDetachedTerminalInstance} (a terminal used elsewhere in Remnants UI).
 */
 ...
 * to represent terminals that appear in other parts of the Remnants UI outside
...
export interface IXtermTerminal extends IDisposable {
	...
	*/
	...
	/**
	 * Selects the content between the two markers by their Remnants OSC `SetMarker`
...
export interface IDetachedXtermTerminal extends IXtermTerminal {
	...
	/**
	 * Updates the xterm log level to match the given Remnants log level.
	 */
	updateLogLevel(): void;
